...
export function Welcome() {
    ...
    return (
        <div>
            ...
            <p>
                Here in our community everyone can propose ideas and vote on them, 
                to help develop and improve the game.
            </p>
            <p>
                To see, create and vote on proposals you need to connect to the 
                site with MetaMask.
            </p>
